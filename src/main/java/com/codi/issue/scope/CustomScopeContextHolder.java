...
public class CustomScopeContextHolder implements Serializable {
     ...
     *
     * @see
     * com.codi.issue.scope.CustomScopeContextHolder#destroyBean(custom.scope.extension.CustomScopeContextHolder.CustomScopeInstance)
     */
